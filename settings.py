...
DEFAULT_DB_DBHOST = os.getenv('DEFAULT_DB_DBHOST', '172.16.70.38')
DEFAULT_DB_DBPORT = os.getenv('DEFAULT_DB_DBPORT', '3308')
...
READONLY_DB_DBHOST = os.getenv('READONLY_DB_DBHOST', '172.16.70.38')
READONLY_DB_DBPORT = os.getenv('READONLY_DB_DBPORT', '3308')
...
DEFAULT_REDIS_HOST = os.getenv('DEFAULT_REDIS_HOST', '172.16.70.38')
